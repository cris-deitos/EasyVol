<?php
/**
 * Anomalie Soci - Visualizzazione
 * 
 * Pagina per visualizzare tutte le anomalie rilevate nei dati dei soci
 */
...
// Verifica permessi
if (!$app->checkPermission('members', 'view_anomalies')) {
    die('Accesso negato - Permesso "Visualizza Anomalie Soci" richiesto');
}
...
$totalAnomalies = 
    ...
    count($anomalies['expired_licenses']) + 
    count($anomalies['expired_courses']);

$pageTitle = 'Anomalie Soci';
?>
<!DOCTYPE html>
<html lang="it">
<head>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <?php if ($totalAnomalies === 0): ?>
                    <div class="alert alert-success">
                        ...
                        Tutti i dati dei soci sono completi e validi.
                    </div>
                <?php else: ?>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="member_edit.php?id=<?php echo $member['id']; ?>" class="btn btn-sm btn-primary">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-info"><?php echo htmlspecialchars($member['member_status']); ?></span></td>
                                    <td>
                                        <a href="member_view.php?id=<?php echo $member['id']; ?>" class="btn btn-sm btn-primary">
                ...
                <div class="card mb-4 anomaly-card" data-anomaly-type="member_expired_licenses">
                    ...
                    <div class="card-body anomaly-content">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <?php foreach ($anomalies['expired_licenses'] as $license): ?>
                                <tr>
                                    <td><?php echo htmlspecialchars($license['registration_number']); ?></td>
                                    <td><?php echo htmlspecialchars($license['name']); ?></td>
                                    <td><?php echo htmlspecialchars($license['license_type']); ?></td>
                                    <td><span class="badge bg-danger"><?php echo date('d/m/Y', strtotime($license['expiry_date'])); ?></span></td>
                                    <td>
                                        <a href="member_view.php?id=<?php echo $license['id']; ?>" class="btn btn-sm btn-primary">
                                            <i class="bi bi-eye"></i> Visualizza
                                        </a>
                                    </td>
                                </tr>
                ...
                <div class="card mb-4 anomaly-card" data-anomaly-type="member_expired_courses">
                    ...
                    <div class="card-body anomaly-content">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <?php foreach ($anomalies['expired_courses'] as $course): ?>
                                <tr>
                                    <td><?php echo htmlspecialchars($course['registration_number']); ?></td>
                                    <td><?php echo htmlspecialchars($course['name']); ?></td>
                                    <td><?php echo htmlspecialchars($course['course_name']); ?></td>
                                    <td><span class="badge bg-danger"><?php echo date('d/m/Y', strtotime($course['expiry_date'])); ?></span></td>
                                    <td>
                                        <a href="member_view.php?id=<?php echo $course['id']; ?>" class="btn btn-sm btn-primary">
                                            <i class="bi bi-eye"></i> Visualizza
                                        </a>
                                    </td>
                                </tr>
