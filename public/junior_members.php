...
$statusCounts = [
    ...
    'sospeso' => $db->fetchOne("SELECT COUNT(*) as count FROM junior_members WHERE member_status = 'sospeso'")['count'] ?? 0,
    'dimesso' => $db->fetchOne("SELECT COUNT(*) as count FROM junior_members WHERE member_status = 'dimesso'")['count'] ?? 0,
];
