...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!CsrfProtection::validateToken($_POST['csrf_token'] ?? '')) {
        ...
        // Validate
        $validTypes = ['decaduto', 'dimesso', 'in_aspettativa', 'sospeso', 'in_congedo'];
        ...
        if (empty($errors)) {
            try {
                ...
                // Update member status based on sanction type
                $memberModel->update($memberId, ['member_status' => $data['sanction_type']]);
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="alert alert-warning">
                                    ...
                                    <strong>Attenzione:</strong> L'inserimento di un provvedimento cambierà automaticamente lo stato del socio.
                                </div>
