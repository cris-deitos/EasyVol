...
('Capo Squadra', 'Responsabile di squadra operativa', 20, 1),
('Coordinatore', 'Coordinatore di settore o territorio', 30, 1),
('Responsabile Formazione', 'Responsabile attività formative', 40, 1),
('Responsabile Logistica', 'Responsabile logistica e magazzino', 50, 1),
('Istruttore', 'Istruttore per corsi di formazione', 60, 1),
('Operatore Radio', 'Operatore radiocomunicazioni', 70, 1),
('Autista Mezzi Pesanti', 'Autista abilitato mezzi speciali', 80, 1),
('Primo Soccorso', 'Operatore primo soccorso', 90, 1),
('Sommozzatore', 'Operatore subacqueo', 100, 1);
