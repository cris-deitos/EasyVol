                ...
                <form method="POST" action="meeting_attachment_upload.php" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="<?php echo $controller->getNextAttachmentNumber($meetingId); ?>" required>
                            <div class="form-text">Assegnato automaticamente, ma editabile</div>
                        </div>
